...
####					velocity components.
####
####	timeAverage:			Adds additional columns onto the dataFrame such as
...
##	Clean up the list NXYZ and store only scalars
	...
	NXYZ = [float(i) for i in NXYZ]
	NXYZ[3] = round(np.abs(NXYZ[3]),5)
...
##	process.
	sampleN = dataRaw.sampleNumber.as_matrix()
